...
public interface CommentRepository extends JpaRepository<Comment, Long> {
    ...
    Page<Comment> findByDiaryIdOrderByCreatedAtDesc(Long diaryId, org.springframework.data.domain.Pageable pageable);

    Page<Comment> findByMemberIdOrderByCreatedAtDesc(Long memberId, org.springframework.data.domain.Pageable pageable);
